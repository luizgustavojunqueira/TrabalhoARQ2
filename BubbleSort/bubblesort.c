...
int main(int argc, char* argv[]) {
   ...
   //Print_list(a, n, "After sort (sequential)");
   printf("Seq Time: %g\n", t);
   ...
   //Print_list(c, n, "After sort (Pthreads)");
